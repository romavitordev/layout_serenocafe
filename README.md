# Sereno — café & torrefação ☕ (GitHub Pages)

> **O instante antes do dia começar.**

🌐 **Ao vivo:** https://romavitordev.github.io/layout_serenocafe/

Mirror **estático** do [serenocafe_lndpage](https://github.com/romavitordev/serenocafe_lndpage) para visualização no GitHub Pages: `output: 'export'` + `basePath: '/layout_serenocafe'`, deploy automático via GitHub Actions a cada push no `main`.
